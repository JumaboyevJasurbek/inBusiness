...
export class table1677138613759 implements MigrationInterface {
    name = 'table1677138613759'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("user_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(32) NOT NULL, "password" character varying(32) NOT NULL, "repeatPassword" character varying(32) NOT NULL, "phone_number" character varying(32) NOT NULL, "email" character varying(128) NOT NULL, "status" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_96aac72f1574b88752e9fb00089" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE TABLE "projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "project" character varying(32) NOT NULL, "company_name" character varying(64) NOT NULL, "business_age" character varying(128) NOT NULL, "employees_number" character varying(64) NOT NULL, "payback" character varying(64) NOT NULL, "reason_for_sale" character varying(64) NOT NULL, "website" character varying(64) NOT NULL, "img" character varying NOT NULL, "userIdUserId" uuid, CONSTRAINT "PK_6271df0a7aed1d6c0691ce6ac50" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "news" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(32) NOT NULL, CONSTRAINT "PK_39a43dfcb6007180f04aff2357e" PRIMARY KEY ("id"))`);
